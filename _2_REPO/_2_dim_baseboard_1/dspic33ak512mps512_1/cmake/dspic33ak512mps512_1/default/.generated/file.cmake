...
set(dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_assemble
...
set_source_files_properties(${dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_assemblePreproc)
set_source_files_properties(${dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_assemblePreproc} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_assemblePreproc})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_compile
...
set_source_files_properties(${dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_compile_cpp)
set_source_files_properties(${dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_compile_cpp} PROPERTIES LANGUAGE CXX)
set(dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_link)
set(dspic33ak512mps512_1_default_default_XC_DSC_FILE_TYPE_bin2hex)
set(dspic33ak512mps512_1_default_image_name "default.elf")
set(dspic33ak512mps512_1_default_image_base_name "default")

# The output directory of the final image.
set(dspic33ak512mps512_1_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/dspic33ak512mps512_1")

# The full path to the final image.
set(dspic33ak512mps512_1_default_full_path_to_image ${dspic33ak512mps512_1_default_output_dir}/${dspic33ak512mps512_1_default_image_name})
