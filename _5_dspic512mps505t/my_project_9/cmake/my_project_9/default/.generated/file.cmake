...
set(my_project_9_default_default_XC_DSC_FILE_TYPE_assemble
...
set_source_files_properties(${my_project_9_default_default_XC_DSC_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${my_project_9_default_default_XC_DSC_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(my_project_9_default_default_XC_DSC_FILE_TYPE_assemblePreproc)
set_source_files_properties(${my_project_9_default_default_XC_DSC_FILE_TYPE_assemblePreproc} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${my_project_9_default_default_XC_DSC_FILE_TYPE_assemblePreproc})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(my_project_9_default_default_XC_DSC_FILE_TYPE_compile
...
set_source_files_properties(${my_project_9_default_default_XC_DSC_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(my_project_9_default_default_XC_DSC_FILE_TYPE_compile_cpp)
set_source_files_properties(${my_project_9_default_default_XC_DSC_FILE_TYPE_compile_cpp} PROPERTIES LANGUAGE CXX)
set(my_project_9_default_default_XC_DSC_FILE_TYPE_link)
set(my_project_9_default_default_XC_DSC_FILE_TYPE_bin2hex)
set(my_project_9_default_image_name "default.elf")
set(my_project_9_default_image_base_name "default")

# The output directory of the final image.
set(my_project_9_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/my_project_9")

# The full path to the final image.
set(my_project_9_default_full_path_to_image ${my_project_9_default_output_dir}/${my_project_9_default_image_name})
